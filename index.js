...
const Solution = () => {
  ...
  fitnessTracker.addListener("goalReached",()=>{
    console.log('Congratulations! You have reached your fitness goal')
  })

  // simulate adding exercise
  fitnessTracker.addExercise({ name: "Running", caloriesBurned: 500 });
  fitnessTracker.addExercise({ name: "Weightlifting", caloriesBurned: 600 });
};
